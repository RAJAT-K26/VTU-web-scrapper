...
# sub_code=form.getvalue("subject_code")
usn_file=form['usn']
sub_code=form['subject_code']
fn_usn=os.path.basename(usn_file.usn)
fn_sub=os.path.basename(sub_code.subject_code)
open("R:\xampp\htdocs\\vtu"+fn_usn+fn_sub,"wb").write(usn_file.file.read())
